...
#config
st.set_page_config(page_title="Solvo Constructora", page_icon="🤖", layout="wide")
...
with st.container():
    st.subheader("Hola, somos Solvo Constructora :wave:")
    st.title("Creamos soluciones para el hábitat saludable")
    st.write(
...
with st.container():
    ...
    with image_column:
        image = Image.open("images/Image Solvo 1.jpg")
